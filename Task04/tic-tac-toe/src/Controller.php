...
namespace bansimbaal\ticTacToe\Controller;

    use bansimbaal\ticTacToe\Model\Board as Board;
    ...
    use function bansimbaal\ticTacToe\View\showGameBoard;
    use function bansimbaal\ticTacToe\View\showMessage;
    use function bansimbaal\ticTacToe\View\getValue;

    use const bansimbaal\ticTacToe\Model\PLAYER_X_MARKUP;
    use const bansimbaal\ticTacToe\Model\PLAYER_O_MARKUP;
